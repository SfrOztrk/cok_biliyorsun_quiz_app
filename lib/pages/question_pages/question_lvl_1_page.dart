...
import '../../questions/questions_level_1.dart';

class QuestionPageLevel1 extends StatefulWidget {
  const QuestionPageLevel1({Key? key}) : super(key: key);

  @override
  _QuestionPageLevel1State createState() => _QuestionPageLevel1State();
}

class _QuestionPageLevel1State extends State<QuestionPageLevel1> {
  List<Widget> choices = [];
  QuestionsLevel1 level = QuestionsLevel1();
