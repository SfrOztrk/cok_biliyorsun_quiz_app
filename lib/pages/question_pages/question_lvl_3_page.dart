...
import '../../questions/questions_level_3.dart';
import '../main_page.dart';

class QuestionPageLevel3 extends StatefulWidget {
  @override
  _QuestionPageLevel3State createState() => _QuestionPageLevel3State();
}

class _QuestionPageLevel3State extends State<QuestionPageLevel3> {
  List<Widget> choices = [];
  QuestionsLevel3 level = QuestionsLevel3();
                            ...
                            child: Padding(
                              ...
                              child: ElevatedButton(
                                ...
                                child: Text(level.getAnswers(1), style: TextStyle(
                                  color: kParibuColor,
                                  fontSize: 25,fontFamily: 'BungeeInline'),
                                  ),
                                onPressed: () {
